...
export const CreateTriggerModal = ({ entity, organizationId, action, onClose }: Props) => {
  ...
  const onSubmit = (data: z.infer<typeof sharedCreateFormSchema>) => {
    fetcher.submit(
      ...
      {
        action: `/organizations/${organizationId}/script/trigger`,
        method: 'POST',
  ...
  return (
    <Dialog open={action === 'create-trigger'} onOpenChange={onClose}>
