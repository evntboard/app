...
export const DeleteModal = ({ organizationId, entity, action, onClose }: Props) => {
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter>
          ...
          >
            ...
            <Button type="submit" className={cn(buttonVariants())} variant="destructive" name="_action" value="delete">
              Delete
              <Icons.loader
